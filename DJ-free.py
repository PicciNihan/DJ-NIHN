...
>>  Facebook : গা্ঁনে্ঁর্ঁ রা্ঁজা্ঁ নি্ঁহা্ঁন্ঁ
...
def fia():    
			...
			print('\x1b[1;91m>>> DJ BAND TEAM  VERSION :\x1b[1;92m 1.1 ')
			...
			if xd in ['1','01']:
				...
				print('Example : /sdcard/DJ NIHAN.txt')
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in NIHAN:
				...
				print('\r\r\033[1;31m[DJ NIHAN-CP] %s | %s'%(ids,pas))
			...
			elif 'checkpoint' in NIHAN:

				if 'y' in pcp:

					print('\r\r\x1b[1;92m[DJ NIHAN-OK] '+ids+' | '+pas+'\033[1;97m')
...
def ffb(ids,names,passlist):
	...
	sys.stdout.write('\r\r\033[1;37m[NIHAN/BRAND] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		...
		for fikr in passlist:
			...
			if "c_user" in DJ NIHAN:
				...
				if 'y' in pcp:
					...
					print('\r\r\x1b[38;5;208m[NIHAN-CP] '+ids+' | '+pas+'\033[1;97m')
